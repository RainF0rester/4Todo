...
def test_soft_delete_task_success():
    ...
    with patch("backend.modules.tasks.repo.get_task", return_value=task), \
         patch("backend.modules.tasks.repo.soft_delete_task", return_value=True):
...
def test_soft_delete_task_repo_failure():
    ...
    with patch("backend.modules.tasks.repo.get_task", return_value=task), \
         patch("backend.modules.tasks.repo.soft_delete_task", return_value=False):
...
def test_restore_task_success():
    ...
    with patch("backend.modules.tasks.repo.get_task", return_value=task), \
         patch("backend.modules.tasks.repo.restore_task", return_value=True):
...
def test_restore_task_repo_failure():
    ...
    with patch("backend.modules.tasks.repo.get_task", return_value=task), \
         patch("backend.modules.tasks.repo.restore_task", return_value=False):
